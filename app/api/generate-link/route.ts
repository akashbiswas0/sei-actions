...
const SYSTEM_PROMPT = `You are an assistant that creates Sei EVM payment link metadata with beautiful dark theme designs.
Return ONLY a strict JSON object with these keys:
{
  "title": string,                 // short human title suitable for a link card
  "amount": number,                // positive number (SEI)
...
- The design must prominently display the title, description, and amount in SEI with clear visual hierarchy.
...
- If the amount is unclear, infer a reasonable SEI amount and mention the inference in the description.
