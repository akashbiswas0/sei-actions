...
import { CreditCard, Save, ArrowRight, Sparkles, Zap, Grid3x3 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-32 left-16 w-96 h-96 bg-red-600/15 rounded-full blur-2xl animate-drift-reverse" style={{animationDelay: '3s'}}></div>
        <div className="absolute top-1/3 left-1/2 w-48 h-48 bg-red-400/20 rounded-full blur-xl animate-pulse-gentle" style={{animationDelay: '1.5s'}}></div>
        ...
        {[...Array(25)].map((_, i) => (
          <div
            ...
            className={`absolute rounded-full ${
              i % 4 === 0 ? 'w-2 h-2 bg-red-400/40' : 
              i % 4 === 1 ? 'w-1.5 h-1.5 bg-red-500/50' : 
              i % 4 === 2 ? 'w-1 h-1 bg-red-600/60' :
          ...
          <div className="px-8 py-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-red-400/80 text-sm font-medium">Payment Dashboard</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-red-500/10 border border-red-500/30 rounded-xl">
                ...
                <span className="text-red-300 text-sm font-medium">Connected</span>
              </div>
              <ConnectButton />
            </div>
          </div>
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center px-8 pb-16">
        ...
        <div className="text-center mb-16 max-w-4xl">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-red-500/10 border border-red-500/30 rounded-full mb-8 backdrop-blur-sm">
            ...
            <span className="text-red-200 font-semibold">Choose Your Action</span>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Manage your payments with ease using our advanced AI-powered platform
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-6xl">
          ...
          >
            ...
            {/* Main card */}
            <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/50 to-red-900/20 border border-red-500/30 rounded-3xl p-10 
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Create custom payment links with just a prompt using our AI-powered generation system
                </p>
                ...
                <div className="space-y-3 pt-4">
                  <div className="flex items-center text-red-300">
                    ...
                    <span className="text-sm font-medium">Share payment links with anyone</span>
                  </div>
                  <div className="flex items-center text-red-300">
                    <div className="w-2 h-2 bg-red-500 rounded-full mr-3 animate-pulse" style={{animationDelay: '0.5s'}}></div>
          ...
          >
            ...
            <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/50 to-red-900/20 border border-red-500/30 rounded-3xl p-10 
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Discover and interact with payment links created by other users in our community
                </p>
                ...
                <div className="space-y-3 pt-4">
                  <div className="flex items-center text-red-300">
                    ...
                    <span className="text-sm font-medium">One-Click Payments</span>
                  </div>
                  <div className="flex items-center text-red-300">
                    <div className="w-2 h-2 bg-red-600 rounded-full mr-3 animate-pulse" style={{animationDelay: '0.5s'}}></div>
                    <span className="text-sm font-medium">Browse community links</span>
                  </div>
                </div>
              </div>
      ...
      <style jsx>{`
        .bg-hexagon-pattern {
          background-image: 
            radial-gradient(circle at 50% 50%, rgba(239, 68, 68, 0.1) 1px, transparent 1px);
