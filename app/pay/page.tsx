          ...
          <div className="relative px-10 py-5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="relative">
                ...
                <div className="flex items-center gap-3">
                  <p className="text-red-300/90 text-sm font-medium tracking-wide">Choose Payment Link</p>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-red-500/20 to-red-600/20 border border-red-500/30 rounded-full backdrop-blur-sm">
                ...
                <span className="text-red-200 text-sm font-medium">Ready to Pay</span>
              </div>
              ...
              <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/50 to-red-900/20 border border-red-500/30 rounded-3xl p-10 
                ...
                <div className="space-y-4">
                  <h3 className="text-2xl font-bold text-white group-hover:text-red-100 transition-colors">
                    Create New Sei Actions
                  </h3>
                  <p className="text-gray-300 text-lg leading-relaxed">
                    Generate your own AI-powered payment link with just a description
                  </p>
                  ...
                  <div className="space-y-3 pt-4">
                    ...
                    <div className="flex items-center text-red-300">
                      ...
                      <span className="text-sm font-medium">Customizable parameters</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/50 to-red-900/20 border border-red-500/30 rounded-3xl p-12 shadow-2xl text-center">
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="space-y-3">
                    <div className="text-white text-2xl font-bold">No payment links found</div>
                    <div className="text-red-300 text-lg">Create your first payment link to get started</div>
                  </div>
                  <Link 
                    href="/save" 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {links.map((l) => (
                ...
                >
                  ...
                  {/* Main card */}
                  <Link href={`/pay/${l.id}`}>
                    <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/50 to-red-900/20 border border-red-500/30 rounded-3xl p-8 
                                   hover:border-red-500/50 transition-all duration-500 shadow-2xl
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="backdrop-blur-sm bg-white/5 border border-red-500/20 rounded-2xl p-4">
                          <div className="text-red-200 text-sm flex items-center gap-3">
                            <span className="font-bold text-xl text-white">{l.amount} SEI</span>
                            <ArrowRight className="w-4 h-4 text-red-400" />
                            <span className="font-mono text-xs bg-black/20 px-3 py-1 rounded-lg">{l.to_account}</span>
                          </div>
                        </div>

                        {l.memo && (
                          <div className="text-red-300 text-sm">
                            <span className="text-red-400 font-medium">Memo:</span> {l.memo}
                          </div>
                        )}
