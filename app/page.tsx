  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-5 sm:top-20 sm:left-20 w-48 h-48 sm:w-96 sm:h-96 bg-red-500/20 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-16 right-8 sm:bottom-32 sm:right-32 w-32 h-32 sm:w-64 sm:h-64 bg-red-600/30 rounded-full blur-2xl animate-float" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 left-1/4 sm:left-1/3 w-16 h-16 sm:w-32 sm:h-32 bg-red-400/40 rounded-full blur-xl animate-bounce-gentle" style={{animationDelay: '1s'}}></div>
      </div>
        ...
        <div className="px-3 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
            <div className="relative">
              <div className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-gradient-to-br from-red-400 to-red-600 rounded-lg sm:rounded-xl flex items-center justify-center backdrop-blur-sm shadow-lg">
                <Link className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
              </div>
              <div className="absolute inset-0 bg-gradient-to-br from-red-400 to-red-600 rounded-lg sm:rounded-xl blur opacity-50"></div>
            </div>
            <div>
              <h1 className="text-lg sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-white via-red-200 to-red-300 bg-clip-text text-transparent">
                Sei Actions
              </h1>
              <p className="text-xs sm:text-xs text-red-300 hidden sm:block">Powered by Sei Network</p>
            </div>
          </div>
      ...
      <main className="relative z-10 min-h-screen flex items-center justify-center px-3 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="text-center mb-10 sm:mb-16 lg:mb-20">
            <div className="inline-flex items-center gap-1 sm:gap-2 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 bg-red-500/10 border border-red-500/30 rounded-full mb-4 sm:mb-6 lg:mb-8 backdrop-blur-sm">
              <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-red-400" />
              <span className="text-xs sm:text-sm lg:text-base text-red-200 font-medium">Revolutionary Payment Links</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12 lg:mb-16 px-4">
              <div className="group cursor-pointer">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white group-hover:text-red-400 transition-colors">0.001s</div>
                <div className="text-red-300 text-xs sm:text-sm uppercase tracking-wide">Transaction Speed</div>
              </div>
              <div className="hidden sm:block w-px h-12 lg:h-16 bg-red-500/30 self-center"></div>
              <div className="group cursor-pointer">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white group-hover:text-red-400 transition-colors">$0.0001</div>
                <div className="text-red-300 text-xs sm:text-sm uppercase tracking-wide">Average Fee</div>
              </div>
              <div className="hidden sm:block w-px h-12 lg:h-16 bg-red-500/30 self-center"></div>
              <div className="group cursor-pointer">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white group-hover:text-red-400 transition-colors">100%</div>
                <div className="text-red-300 text-xs sm:text-sm uppercase tracking-wide">Uptime</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-10 sm:mb-16 lg:mb-20 px-2 sm:px-0">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-black/50 border border-red-500/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 backdrop-blur-sm hover:border-red-500/50 transition-all duration-300 h-full">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 lg:mb-4">Generate Sei Actions</h3>
                ...
                <div className="flex flex-wrap gap-1 sm:gap-2">
                  <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">Secure</span>
                  <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">Customizable</span>
                  <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">Instant</span>
                </div>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-black/50 border border-red-500/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 backdrop-blur-sm hover:border-red-500/50 transition-all duration-300 h-full">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 lg:mb-4">Execute Sei Actions</h3>
                <p className="text-sm sm:text-base text-gray-300 leading-relaxed mb-4 sm:mb-5 lg:mb-6">
                  Load payment details instantly and execute transactions seamlessly with your connected wallet in one click.
                </p>
                <div className="flex flex-wrap gap-1 sm:gap-2">
                  <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">One-Click</span>
                  <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">Fast</span>
                  <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">Reliable</span>
                </div>
              </div>
            </div>
            ...
            <div className="group relative md:col-span-1">
              ...
              <div className="relative bg-black/50 border border-red-500/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 backdrop-blur-sm hover:border-red-500/50 transition-all duration-300 h-full">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 lg:mb-4">AI Customization</h3>
                <p className="text-sm sm:text-base text-gray-300 leading-relaxed mb-4 sm:mb-5 lg:mb-6">
                  Tailor your payment links with AI-generated designs and prompts for personalized user experiences.
                </p>
                <div className="flex flex-wrap gap-1 sm:gap-2">
                  <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">AI-Powered</span>
                  <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">Custom UI</span>
                  <span className="px-2 sm:px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">Smart</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative max-w-xs sm:max-w-2xl lg:max-w-4xl mx-auto">
              ...
              <div className="relative bg-black/40 border border-red-500/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 backdrop-blur-md">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                  ...
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white text-center">Ready to revolutionize payments?</h2>
                </div>
      ...
      <section className="relative z-10 py-10 sm:py-15 lg:py-20">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 text-sm sm:text-base lg:text-lg mb-6 sm:mb-8 lg:mb-12">Watch as AI transforms your payment needs into instant Sei Actions</p>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex items-center space-x-3 sm:space-x-6 lg:space-x-8 animate-slide-sequence scale-75 sm:scale-90 lg:scale-100">
                <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
                  ...
                  <div className="text-red-300 text-sm sm:text-base lg:text-lg">+</div>
                  ...
                  <div className="flex items-center space-x-1 sm:space-x-2 bg-red-500/20 px-2 sm:px-3 lg:px-4 py-1 sm:py-2 rounded-full border border-red-500/40">
                    <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-red-400" />
                    <span className="text-white font-semibold text-xs sm:text-sm lg:text-base">SeiLink Magic!</span>
                  </div>
                </div>
              </div>
            </div>
