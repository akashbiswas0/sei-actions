          ...
          <div className="px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-red-400/80 text-sm font-medium">Create Payment Links</p>
              </div>
            </div>
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center px-8 pb-16">
        ...
        <div className="text-center mb-16 max-w-4xl">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-red-500/10 border border-red-500/30 rounded-full mb-8 backdrop-blur-sm">
            ...
            <span className="text-red-200 font-semibold">AI-Powered Blockchain Links Generation</span>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Generate intelligent payment links with AI assistance and customize them to your needs
          </p>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-red-300 rounded-full animate-ping" style={{animationDelay: '0.5s'}}></div>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-red-300/80 text-lg">Transform your ideas into smart payment links</p>
                    </div>
                  </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute right-4 top-4">
                      <div className="w-2 h-2 bg-red-500/60 rounded-full animate-pulse" style={{animationDelay: '0.3s'}}></div>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative group">
                ...
                <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/30 via-green-950/10 to-black/30 border border-green-500/20 rounded-2xl p-8 shadow-xl">
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h4 className="text-2xl font-bold text-white">Generated Preview</h4>
                      <p className="text-green-300/80">Review and customize your payment link</p>
                    </div>
                  </div>
                  
                  {/* Preview Content */}
                  {genComponentHtml ? (
                    <div className="rounded-2xl border-2 border-green-500/30 overflow-hidden backdrop-blur-sm bg-white/5 mb-6" 
                    ...
                    <div className="backdrop-blur-sm bg-white/5 border-2 border-green-500/30 rounded-2xl p-6 mb-6">
                      <div className="text-2xl font-bold text-white mb-3">{genTitle || "Payment"}</div>
                      <div className="text-green-200 text-lg mb-2">
                        {genAmount ? `${genAmount} SEI` : "Amount TBD"} → {to || "recipient"}
                      </div>
                      {genDescription && <div className="text-green-300 mb-2">{genDescription}</div>}
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <label className="block text-xs font-medium text-red-200">Title</label>
                      <input 
                    ...
                    <div className="space-y-2">
                      <label className="block text-xs font-medium text-red-200">Amount (SEI)</label>
                      <input 
                        type="number" 
                        min="0" 
                        step="0.000001" 
                    ...
                    <div className="space-y-2">
                      <label className="block text-xs font-medium text-red-200">Description</label>
                      <input 
                        className="w-full backdrop-blur-sm bg-white/10 border border-red-500/30 rounded-xl px-3 py-2 text-white
                                   focus:border-red-400 focus:ring-2 focus:ring-red-400/50 transition-all duration-300" 
                  ...
                  {savedId && (
                    <div className="backdrop-blur-sm bg-green-500/20 border-2 border-green-400/40 rounded-2xl px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-green-200 font-semibold">Successfully Saved!</span>
                        <Link 
                          href={`/pay/${savedId}`}
            ...
            <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/50 to-red-900/20 border border-red-500/30 rounded-3xl p-10 
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">Your Payment Links</h3>
                    <p className="text-red-300">Manage and track your created links</p>
                  </div>
                </div>
                <Link 
                  href="/pay" 
              ...
              {links.length === 0 ? (
                <div className="backdrop-blur-sm bg-white/5 border border-red-500/30 rounded-2xl p-8 text-center">
                  ...
                  <div className="text-red-200 text-lg">No links yet. Create one above.</div>
                  <div className="text-red-300 text-sm mt-2">Your generated payment links will appear here</div>
                </div>
              ) : (
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-2">
                          ...
                          <div className="text-red-200 text-sm">
                            <span className="font-semibold">{l.amount} SEI</span> → {l.to_account}
                            {l.memo && <span className="text-red-300"> • {l.memo}</span>}
                          </div>
                          {l.total_paid > 0 && (
